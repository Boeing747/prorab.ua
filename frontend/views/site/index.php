...
<div clas="row" class="main-text-block">
    ...
    <div class="col-xs-6" >
        ...
        <button data-item="/catalog" class="js_url find-btn center-block"></button>
    </div>
</div>
...
<div class="row full-row quest text-center">
    ...
    <div class="col-xs-12">
        <button class="js_url reg-btn" data-item="/registration" type="button" />
    </div>
</div>
        ...
        <div class="col-xs-12 stat text-center">
            <div class="stat-circles">
                <div class="diag1-block">
                    <div class="diag1 text-center"><?= $usersCount[1]['cnt']?></div>
                    <div class="diag-text text-center">виконробів</div>
                </div>
                <div class="diag2-block">
                    <div class="diag2 text-center"><?= $usersCount[2]['cnt']?></div>
